...
impl ActionsInfo {
    ...
    fn next(&mut self, physics: &mut shared::Physics,) {
        match self.active {
            Some(data) => {
    ...
    pub fn update(&mut self, physics: &mut shared::Physics, delta: f32, impls: &action_system::ActionsImpl) {
...
pub struct ActionData {
    ...
    pub total_time: f32,
    init: shared::Physics,
    action: action_system::Actions, //usizefn(time_passed: f32, physics: &mut shared::Physics, init: &shared::Physics),
    done_fn: Option<fn()>,
}
...
impl ActionData {
    ...
    pub fn new(action: action_system::Actions, done_fn: Option<fn()>, init: shared::Physics) -> ActionData {
    ...
    pub fn reset(&self, physics: &mut shared::Physics) {
