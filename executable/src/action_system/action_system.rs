...
pub fn update_actions(actions: &mut std::collections::HashMap<usize, entity::ActionsInfo>, physics: &mut std::collections::HashMap<usize, shared::Physics>, delta: f32, impls: &ActionsImpl) {
...
impl BezierAction {
    pub fn update(&self, time_passed: f32, physics: &mut shared::Physics, init: &shared::Physics) {
...
impl Action for BezierAction {
    fn update(&self, time_passed: f32, physics: &mut shared::Physics, init: &shared::Physics) {
...
pub struct FuncAction {
    pub update_fn: fn(time_passed: f32, physics: &mut shared::Physics, init: &shared::Physics)
}
...
impl ActionsImpl {
    ...
    pub fn update(&self, action: Actions, t: f32, physics: &mut shared::Physics, init: &shared::Physics) {
        match action {
